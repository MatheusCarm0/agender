              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  {theme.logoUrl ? (
                    ...
                    <div className="w-16 h-16 rounded-full bg-surface-subtle border border-border-default flex items-center justify-center text-text-subtle text-xs">
                      Sem logo
                    </div>
                  )}
                  <div className="flex flex-col gap-1">
                    <label className="h-8 px-3 text-xs font-medium border border-border-strong text-text-default rounded-[var(--radius-sm)] hover:bg-surface-subtle cursor-pointer flex items-center gap-1.5">
                      {uploading === 'logo' ? 'Enviando...' : 'Escolher arquivo'}
                      <input
                        type="file"
                  ...
                  {theme.coverUrl ? (
                    ...
                    <label className="flex flex-col items-center justify-center h-24 border-2 border-dashed border-border-strong rounded-[var(--radius-sm)] cursor-pointer hover:bg-surface-subtle transition-colors">
                      <span className="text-xs text-text-muted">
                        {uploading === 'cover' ? 'Enviando...' : 'Clique para enviar uma imagem de capa'}
                      </span>
                      <input
                        type="file"
                        accept="image/jpeg,image/png,image/webp"
              ...
              <div className={`p-6 flex flex-col items-center text-center ${theme.coverUrl ? '-mt-10' : ''}`}>
                ...
                {(data.socials.instagram ||
                  ...
                  <div className="flex gap-4 mt-4">
                    {data.socials.instagram && (
                      <span className="opacity-70 hover:opacity-100 transition-opacity" style={{ color: theme.colors.text }} title="Instagram">
                    ...
                    {data.socials.whatsapp && (
                      <span className="opacity-70 hover:opacity-100 transition-opacity" style={{ color: theme.colors.text }} title="WhatsApp">
                    ...
                    {data.socials.facebook && (
                      <span className="opacity-70 hover:opacity-100 transition-opacity" style={{ color: theme.colors.text }} title="Facebook">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                      </span>
                    )}
                    {data.socials.tiktok && (
                      <span className="opacity-70 hover:opacity-100 transition-opacity" style={{ color: theme.colors.text }} title="TikTok">
