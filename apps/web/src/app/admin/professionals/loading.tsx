  ...
  return (
    <div>
      ...
      <div className="bg-surface-card border border-border-default rounded-[var(--radius-md)] overflow-hidden">
        ...
        {[1, 2, 3].map((i) => (
          <div key={i} className="flex items-center gap-3 px-4 py-4 border-t border-border-default">
            ...
            <div className="flex-1 space-y-1.5">
              ...
              <div className="h-3 w-40 bg-surface-subtle rounded animate-pulse" />
            </div>
            <div className="h-6 w-16 bg-surface-subtle rounded-full animate-pulse" />
          </div>
        ))}
      </div>
    </div>
